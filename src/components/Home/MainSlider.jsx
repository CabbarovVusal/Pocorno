  ...
  return (
    <div>
      <div ref={sliderRef} className="keen-slider ">
        <NavLink to={"/shop"} className="card1 keen-slider__slide h-450 group">
          <div className="imgs overflow-hidden">
            <img
              className="h-auto group-hover:scale-[1.03] duration-300 rounded-tr-[12rem] max-[1200px]:rounded-tr-[6rem]"
        ...
        <NavLink
          to={"/shop"}
          className="card1 keen-slider__slide w-auto h-450 group"
        >
          <div className="imgs overflow-hidden">
            <img
              className="h-auto group-hover:scale-[1.03] duration-300 rounded-tr-[12rem] max-[1200px]:rounded-tr-[6rem]"
